...
namespace Bon
{
	...
	[AttributeUsage(.Class|.Struct|.Enum, .AlwaysIncludeTarget, ReflectUser = .AllMembers | .DefaultConstructor, AlwaysIncludeUser = .IncludeAllMethods /* for default constructor */ | .AssumeInstantiated)]
