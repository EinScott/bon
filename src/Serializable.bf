...
namespace Bon
{
	...
	[AttributeUsage(.Class|.Struct|.Enum, .AlwaysIncludeTarget, ReflectUser = .AllMembers | .DefaultConstructor, AlwaysIncludeUser = .IncludeAllMethods | .AssumeInstantiated)]
	...
	// For inaccessible library types, you can also just manually call gBonEnv.RegisterPolyType!(type) for it.
	[AttributeUsage(.Class, ReflectUser = .Type)]
